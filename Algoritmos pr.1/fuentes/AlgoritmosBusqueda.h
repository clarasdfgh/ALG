...
public:
  ...
  /*
   ...
   /* Busqueda Secuencial RC para la modificacion de la práctica 3*/
   int BusquedaSecuencialRc(int v[], int size, int key);
   ...
   int busquedaBinariaRc(int v[], int size,int key);
	 ...
	 */
	 ...
	 /*
	 Busqueda Binaria It para la modificación de la práctica 3
	 */
	 int busquedaBinariaIt(int v[], int size, int key);
	 int BinariaIt(int A[], int primero, int ultimo, int key);
};
#endif